...
const ui = {
  ru: {
    ...
    homeNoStoriesAbout: "О {name} в архиве пока нет ни одного рассказа.",
    homeTellAbout: "Рассказать о {name}",
  ...
  en: {
    ...
    processingFailed: "GigaAM is unavailable. Restart the Kaggle worker and process again.",
    retrySavedRecording: "Retry this recording",
    retryNeedsWorker: "Restart the Kaggle worker first.",
